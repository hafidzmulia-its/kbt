...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \fill[Navy] (current page.north west) rectangle ([yshift=-0.95cm]current page.north east);
  \fill[SoftBlue] ([xshift=11.7cm,yshift=-0.6cm]current page.north west) circle (0.8cm);
  \fill[Blue!10] ([xshift=11.8cm,yshift=-6.7cm]current page.north west) circle (1.05cm);

  \node[rounded corners=18pt, fill=white, draw=SoftBlue, line width=0.9pt,
        minimum width=4.45cm, minimum height=4.6cm, anchor=north east] at ([xshift=-0.75cm,yshift=-1.25cm]current page.north east) {};

  \begin{scope}[shift={([xshift=-3.02cm,yshift=-3.95cm]current page.north east)}]
    \draw[rounded corners=4pt, fill=SoftBlue, draw=Blue, line width=1.0pt] (-1.0,-0.5) rectangle (1.0,0.8);
    \draw[rounded corners=3pt, fill=Blue!15, draw=Blue, line width=1.0pt] (-1.15,0.75) rectangle (1.15,1.25);
    \draw[Blue, line width=1.4pt] (0,-0.5) -- (0,1.25);
    \draw[Blue, line width=1.2pt] (-0.15,1.25) .. controls (-0.55,1.65) and (-0.15,2.0) .. (0.0,1.62);
    \draw[Blue, line width=1.2pt] (0.15,1.25) .. controls (0.55,1.65) and (0.15,2.0) .. (0.0,1.62);
    \draw[Blue, line width=1.2pt] (-0.08,1.22) .. controls (-0.30,1.55) and (-0.05,1.82) .. (0.0,1.60);
    \draw[Blue, line width=1.2pt] (0.08,1.22) .. controls (0.30,1.55) and (0.05,1.82) .. (0.0,1.60);

    \node[circle,fill=white,draw=SoftBlue,minimum size=0.7cm] at (-1.65,1.05) {\scriptsize AI};
    \node[circle,fill=white,draw=SoftBlue,minimum size=0.78cm] at (1.78,0.35) {\scriptsize RSVP};
    \node[circle,fill=white,draw=SoftBlue,minimum size=0.75cm] at (1.45,1.65) {\scriptsize Gift};
    \draw[Blue!65,line width=0.8pt] (-0.55,1.02) -- (-1.28,1.02);
    \draw[Blue!65,line width=0.8pt] (0.98,0.45) -- (1.38,0.40);
    \draw[Blue!65,line width=0.8pt] (0.60,1.20) -- (1.08,1.50);
  \end{scope}
\end{tikzpicture}
...
{\color{white}\small\bfseries PROPOSAL BISNIS DIGITAL}\\[0.65cm]
{\color{Navy}\fontsize{18}{22}\selectfont\bfseries Ide Bisnis dan Analisa Kelayakan:\\Undangan Nikah Digital dan Gifting Site berbasis AI}\\[0.28cm]
{\color{TextDark}\normalsize Analisa kelayakan difokuskan pada potensi pasar, diferensiasi produk, dan langkah MVP yang realistis untuk NechCode.}\\[0.32cm]
\pill{Wedding Tech}\hspace{0.08cm}\pill{AI Template}\hspace{0.08cm}\pill{RSVP Tracking}\hspace{0.08cm}\pill{Gifting Site}\\[0.38cm]
{\color{Navy}\bfseries Kelompok 12} \hspace{0.2cm} {\color{TextMuted}\small Maret 2026}
\end{minipage}
\end{frame}
